...
describe('RegisterUserDto', () => {
    ...
    test('should create a valid DTO with correct values', () => {
        ...
        // Creación del DTO
        const [error, registerUserDto] = register_user_dto_1.RegisterUserDto.create(userData);
        // Verificaciones
        expect(error).toBeUndefined();
        expect(registerUserDto).toBeInstanceOf(register_user_dto_1.RegisterUserDto);
        // Verificar valores correctos y transformaciones
        expect(registerUserDto === null || registerUserDto === void 0 ? void 0 : registerUserDto.name).toBe('test user'); // debe estar en minúsculas
        expect(registerUserDto === null || registerUserDto === void 0 ? void 0 : registerUserDto.email).toBe('test@example.com');
        expect(registerUserDto === null || registerUserDto === void 0 ? void 0 : registerUserDto.password).toBe('password123');
    });
