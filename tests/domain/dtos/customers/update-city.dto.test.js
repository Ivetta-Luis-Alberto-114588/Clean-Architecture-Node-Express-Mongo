...
describe('UpdateCityDto', () => {
    ...
    test('should create a valid DTO with all fields', () => {
        ...
        // Creación del DTO
        const [error, updateCityDto] = update_city_dto_1.UpdateCityDto.update(updateData);
        // Verificaciones
        expect(error).toBeUndefined();
        expect(updateCityDto).toBeInstanceOf(update_city_dto_1.UpdateCityDto);
        // Verificar valores correctos y transformaciones
        expect(updateCityDto === null || updateCityDto === void 0 ? void 0 : updateCityDto.name).toBe('buenos aires updated'); // debe estar en minúsculas
        expect(updateCityDto === null || updateCityDto === void 0 ? void 0 : updateCityDto.description).toBe('capital federal'); // debe estar en minúsculas
        expect(updateCityDto === null || updateCityDto === void 0 ? void 0 : updateCityDto.isActive).toBe(false);
    });
    ...
    test('should create a valid DTO with partial fields', () => {
        ...
        // Verificar valores correctos y transformaciones
        expect(updateCityDto === null || updateCityDto === void 0 ? void 0 : updateCityDto.name).toBe('buenos aires updated'); // debe estar en minúsculas
        expect(updateCityDto === null || updateCityDto === void 0 ? void 0 : updateCityDto.description).toBeUndefined(); // no se proporcionó
        expect(updateCityDto === null || updateCityDto === void 0 ? void 0 : updateCityDto.isActive).toBeUndefined(); // no se proporcionó
    });
