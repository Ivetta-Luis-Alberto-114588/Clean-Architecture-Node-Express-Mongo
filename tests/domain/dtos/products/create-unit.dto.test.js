...
const create_unit_dto_1 = require("../../../../src/domain/dtos/products/create-unit.dto");
describe('CreateUnitDto', () => {
    ...
    test('should create a valid DTO with correct values', () => {
        ...
        // Creación del DTO
        const [error, createUnitDto] = create_unit_dto_1.CreateUnitDto.create(unitData);
        // Verificaciones
        expect(error).toBeUndefined();
        expect(createUnitDto).toBeInstanceOf(create_unit_dto_1.CreateUnitDto);
        // Verificar valores correctos y transformaciones
        expect(createUnitDto === null || createUnitDto === void 0 ? void 0 : createUnitDto.name).toBe('test unit'); // debe estar en minúsculas
        expect(createUnitDto === null || createUnitDto === void 0 ? void 0 : createUnitDto.description).toBe('test unit description'); // debe estar en minúsculas
        expect(createUnitDto === null || createUnitDto === void 0 ? void 0 : createUnitDto.isActive).toBe(true);
    });
    ...
    test('should convert name and description to lowercase', () => {
        ...
        expect(error).toBeUndefined();
        expect(createUnitDto).toBeInstanceOf(create_unit_dto_1.CreateUnitDto);
        expect(createUnitDto === null || createUnitDto === void 0 ? void 0 : createUnitDto.name).toBe('test unit');
        expect(createUnitDto === null || createUnitDto === void 0 ? void 0 : createUnitDto.description).toBe('test unit description');
    });
    ...
    test('should create a valid DTO with isActive set to false', () => {
        ...
        expect(error).toBeUndefined();
        expect(createUnitDto).toBeInstanceOf(create_unit_dto_1.CreateUnitDto);
        expect(createUnitDto === null || createUnitDto === void 0 ? void 0 : createUnitDto.isActive).toBe(false);
    });
});
