...
describe('CustomerEntity', () => {
    ...
    test('should create a CustomerEntity instance with all properties', () => {
        ...
        const isActive = true;
        // Act
        const customer = new customer_1.CustomerEntity(id, name, email, phone, address, mockNeighborhood, isActive);
        // Assert
        expect(customer).toBeInstanceOf(customer_1.CustomerEntity);
    ...
    test('should set isActive to true by default when not provided', () => {
        ...
        const customer = new customer_1.CustomerEntity(id, name, email, phone, address, mockNeighborhood);
        // Assert
