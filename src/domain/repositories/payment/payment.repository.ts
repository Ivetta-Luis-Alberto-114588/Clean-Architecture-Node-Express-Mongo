// src/domain/repositories/payment/payment.repository.ts
...
export abstract class PaymentRepository {
  ...
  // Obtener un pago por su ID de proveedor MP
  abstract getPaymentByProviderPaymentId(providerPaymentId: string): Promise<PaymentEntity | null>;
