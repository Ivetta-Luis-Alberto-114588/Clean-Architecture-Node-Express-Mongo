...
interface IFindSalesByDateRangeUseCase {
    execute(startDate: Date, endDate: Date, paginationDto: PaginationDto): Promise<SaleEntity[]>
}
...
export class FindSalesByDateRangeUseCase implements IFindSalesByDateRangeUseCase {
    ...
    async execute(startDate: Date, endDate: Date, paginationDto: PaginationDto): Promise<SaleEntity[]> {
        try {
